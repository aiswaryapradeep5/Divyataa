...
// Assets
import campusImg from '../assets/schlImg.png';
...
import silambamImg from '../assets/image (4).png';
...
import annualDayImg2 from '../assets/sports&cocurricular/image(101).png';
...
import eventImg from '../assets/IMG_7231.JPG';
import eventImg1 from '../assets/events&annualday/5C7A9141.JPG';
import Img1 from '../assets/sports&cocurricular/image (1).png';
import Img11 from '../assets/sports&cocurricular/image (11).png';
          ...
          <div className="bg-white rounded-[2.5rem] p-8 md:p-16 shadow-sm border border-slate-100 flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-500 leading-relaxed normal">
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {[campusImg, silambamImg, outdoorImg, learningImg, annualDayImg, gal1, gal2, gal3, whyMontessoriImg, eventImg, eventImg1, Img1, Img11].map((img, idx) => (
              <motion.div
                key={idx}
                variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }}
      ...
      <section className="py-24 px-6 bg-slate-50">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="absolute inset-4 rounded-[2.5rem] border-2 border-purple-300 pointer-events-none" />
